"""Config flow to configure Switcher."""
import logging
...
class DomainOptionsFlowHandler(config_entries.OptionsFlow):
    ...
    async def async_step_init(self, user_input=None):
        ...
        return await self.async_step_switcher_additional_settings(user_input)

    async def async_step_switcher_additional_settings(self, user_input=None):
